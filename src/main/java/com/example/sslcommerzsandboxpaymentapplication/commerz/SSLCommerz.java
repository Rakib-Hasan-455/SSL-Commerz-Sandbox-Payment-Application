package com.example.sslcommerzsandboxpaymentapplication.commerz;

import com.example.sslcommerzsandboxpaymentapplication.commerz.Utility.ParameterBuilder;
import com.example.sslcommerzsandboxpaymentapplication.commerz.Utility.Util;
import com.example.sslcommerzsandboxpaymentapplication.commerz.parametermappings.SSLCommerzInitResponse;
import com.example.sslcommerzsandboxpaymentapplication.commerz.parametermappings.SSLCommerzValidatorResponse;
...
public class SSLCommerz {
    ...
    private void setSSLCzTestMode(boolean storeTestMode) {
        ...
        if (storeTestMode) {
             this.storeId = "docto62c031c5a653e";
             this.storePass = "docto62c031c5a653e@ssl";
